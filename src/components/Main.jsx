    ...
    <div className=" bg-cover bg-[url('./assets/images/footer-background.png')] w-screen text-center  h-screen flex flex-col gap-6 justify-center items-center text-white-A700">
      <div>
        <div className=" flex gap-4 justify-between items-center">
            <div><img src="./logos/leftVector.svg" className=" w-24"></img></div>
            <div><p className="tablet:text-7xl mobile:text-3xl font-semibold">Why Should You Join Airblack?</p></div>
            <div><img src="./logos/rightVector.svg" className=" w-24"/></div>
        </div>
      </div>
      <div className="flex flex-row mt-5 gap-6 justify-between items-center ">
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <p className=" mobile:text-lg tablet:text-3xl">Do-it-together, live on zoom</p>
        </div>
        <div className="flex flex-col justify-center items-center gap-4">
          <img src="./logos/star.svg" className=" mobile: w-12 tablet:w-20" />
          <p className=" mobile:text-lg tablet:text-3xl">4.8 /5 Rated Classes</p>
        </div>
        <div className="flex flex-col justify-center items-center gap-4">
