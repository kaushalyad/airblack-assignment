...
const Main = () => {
  return (
    <div className=" bg-cover bg-[url('./assets/images/footer-background.png')] w-screen text-center  h-screen flex flex-col gap-6 justify-center items-center text-white-A700">
      ...
      <div className="flex flex-row mt-5 gap-2 justify-evenly items-center ">
        <div className="flex flex-col  w-1/3 justify-center items-center gap-4">
          <img src="./logos/video.svg" className=" mobile:w-12 tablet:w-20" />
          <p className=" mobile:text-base tablet:text-3xl">
        ...
        <div className="flex flex-col w-1/3 justify-center items-center gap-4">
          ...
          <div className=" flex flex-col">
            <p className=" mobile:text-base tablet:text-3xl">4.8 /5</p>
            <p className=" mobile:text-base tablet:text-3xl">Rated Classes</p>
          </div>
        </div>
        <div className="flex flex-col w-1/3 justify-center items-center gap-4">
          <img src="./logos/people.svg" className=" mobile:w-12 tablet:w-20" />
          <p className=" mobile:text-base tablet:text-3xl">35000+ Members</p>
        </div>
      </div>
